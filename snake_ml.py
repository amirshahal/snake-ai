...
class Game:
    def __init__(self):
        ...
        self.snake = Snake(self.display_params)
        self.fruit = Fruit(self.display_params)
    ...
    def handle_key_event(self):
        ...
        for event in pygame.event.get():
            ...
            if change_to is not None and args.interactive:
                if change_to == 'UP' and self.snake.direction != 'DOWN':
                    self.snake.direction = 'UP'
                if change_to == 'DOWN' and self.snake.direction != 'UP':
                    self.snake.direction = 'DOWN'
                if change_to == 'LEFT' and self.snake.direction != 'RIGHT':
                    self.snake.direction = 'LEFT'
                if change_to == 'RIGHT' and self.snake.direction != 'LEFT':
        ...
        for episode in range(args.episodes):
            while True:
                ...
                if self.do_snake_fruit_collide():
                    ...
                    # trimming the tail (on top of adding to head) make the Snake move
